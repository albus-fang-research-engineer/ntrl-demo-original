...
pt='./Experiments/UR5/arm_04_22_14_51/Model_Epoch_05100_ValLoss_4.404842e-03.pt'
print(pt)
womodel.load(pt)#
...
# XP = torch.tensor([[-0.5 - np.pi/2, -0.88, -0.8, 0.5*np.pi, 0.5*np.pi, 0.0,
#                 0.1 - np.pi/2, -0.5, -0.35, 0.2*np.pi, 0.5*np.pi, 0.0]]).cuda()
